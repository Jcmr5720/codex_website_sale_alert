...
# =====================================================================================
{
    ...
    'summary': 'Add Notes and Categories to conversations. WhatsApp integration. WhatsApp Connector. '
               'GupShup. Chat-Api. ChatApi. ChatRoom 2.0.',
    'description': 'Add Notes and Categories to conversations. WhatsApp integration. WhatsApp Connector. '
                   'GupShup. Chat-Api. ChatApi. ChatRoom 2.0.',
    'version': '16.0.4.',
    'author': 'AcruxLab',
